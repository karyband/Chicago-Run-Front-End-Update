...
<div style="clear:both"></div> 
 ...
 <div id="header" name="header" runat="server" style="display: none"> 
    ...
    <div id="printStudentBtn" class="button" style="width:120px;float:left">Print Roster</div><asp:HyperLink ID="AddUser" runat="server" Visible="false"><div class="button" style="width:140px;margin-left:5px;float:left;">User Maintenance</div></asp:HyperLink> 
    <div style="clear:both"></div>
